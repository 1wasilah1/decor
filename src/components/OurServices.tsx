...
export default function OurServices() {
  ...
  const services = [
    ...
    { 
      ...
      media: '/service/Rental-Backdrop.mp4',
      type: 'video'
    },
    { 
      title: t('service5'),
      desc: 'Create memorable moments instantly. Our professional backdrop photobooth setups provide the perfect background for any event. High-quality, customizable designs that capture your brand essence while giving guests an unforgettable photo experience. Easy setup, stunning results, and lasting memories for every occasion.',
    ...
    { 
      ...
      media: '/service/Custom-CNC-Cutting.jpeg',
      type: 'image'
    },
    { 
      title: t('service9'),
