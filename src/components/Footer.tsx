          ...
          <div className="col-span-1 md:col-span-2">
            <div className="mb-6">
              <div className="text-2xl font-bold">
                <div>PT. Blue Sky Indonusa</div>
                <div>PT. Multi Tritama Persada</div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3 mb-8">
              <a href="https://www.instagram.com/backdrop.booth.furniture.event/" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 text-gray-300 hover:text-white transition-colors">
                ...
                <span>@backdrop.booth.furniture.event</span>
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © 2025 PT. Blue Sky Indonusa &amp; PT. Multi Tritama Persada. All rights reserved.
            </p>
